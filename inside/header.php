...
<head>
    ...
    <title>Reliable Bearing Manufacturer | SAB Bearings India</title>
    <meta name="description"
        content="SAB Bearings is a trusted Indian manufacturer of precision-engineered bearings for automotive, railways, and heavy machinery. ISO-certified and built for performance under extreme conditions." />
                ...
                <nav class="navbar navbar-expand-lg navbar-light d-none d-lg-block">
                    <div class="container-fluid px-5">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <div class="logo">
                                <img src="assets/img/p1.png" alt="" class="img1">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav " id="primary">
                    ...
                    <div class="container">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" id="primary">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a class="dropdown-item" href="Maritime.html">Maritime Consultancy</a>
                                            </li>
                                        </ul>
                                    </li>
